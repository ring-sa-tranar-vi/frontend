...
export const GUEST_SESSION_INSTRUCTION = [
  ...
  'Du får inte avsluta sessionen om inte användaren indikerat att de vill avsluta.',
  'När användaren har indikerat att de vill avsluta ska du uppmuntra användaren att logga in för att skapa en profil för att kunna byta tränare, få anpassade övningar, delta i events och mera.',
